...
public class UpdateChecker {
    ...
    public static final String UPDATE_CHECK_URL = FCLApplication.Prop.getProperty("check-update-url","https://raw.githubusercontent.com/hyplant-team/FoldCraftLauncher/doc/version_map/latest.json");
